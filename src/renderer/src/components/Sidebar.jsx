...
const NAV_ITEMS = [
  ...
  { to: '/transport',     icon: 'transport', label: 'Transport',             module: 'finance'    },
...
const ICONS = {
  ...
  transport: <><path d="M3 6h13v9H3z" stroke="currentColor" strokeWidth="1.8" fill="none"/><path d="M16 9h3l2 3v3h-5z" stroke="currentColor" strokeWidth="1.8" fill="none"/><circle cx="7" cy="17" r="1.6" fill="currentColor"/><circle cx="17" cy="17" r="1.6" fill="currentColor"/></>,
