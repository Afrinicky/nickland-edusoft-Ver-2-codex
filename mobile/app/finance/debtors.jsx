...
import { Card, Section, Grid, StatCard, SearchField, DataTable, Muted, EmptyState, Badge } from '../../src/ui';
          ...
          <>
            ...
            <Section title="Arrears" icon="trend" subtitle="Largest first.">
              <DataTable
                ...
                onRowPress={(r) => r.student_id && router.push(`/finance/student/${r.student_id}`)}
                columns={[
