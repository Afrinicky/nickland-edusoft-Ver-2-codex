...
import { PrintButton } from '../../actions';

import { Bars, Meter, DayStrip, toneForScore } from '../../charts';
import { whatsappHref, telHref, open as openLink } from '../../contact';
      ...
      <Screen>
        ...
        <Card>
          <EmptyState
            ...
            action={<Button title="Back to the roll" onPress={() => router.replace('/app/students?tab=roll')} full={false} />}
          />
        </Card>
      </Screen>
    );
      ...
      <Card>
        <Toolbar>
          ...
          <Button
            ...
            onPress={() => router.push('/app/academics?tab=results')}
          />
        </Toolbar>
      </Card>
